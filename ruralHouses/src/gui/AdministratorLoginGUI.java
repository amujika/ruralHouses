...
public class AdministratorLoginGUI extends JFrame {
	...
	public AdministratorLoginGUI() {
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Administrator administratorTriesToLogIn = new Administrator(null, username, password);

				try {
					administratorTriesToLogIn = facade.administratorloginBL(administratorTriesToLogIn);
				} catch (RemoteException e) {
					e.printStackTrace();
				}

				if (administratorTriesToLogIn == null) {
					...
					StartWindow.ADMINISTRATOR = administratorTriesToLogIn;
					JFrame a = new AdministratorGUI();
					a.setVisible(true);
					AdministratorLoginGUI.this.setVisible(false);					
				} 
